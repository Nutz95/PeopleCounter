...
const _benchmarkMetricCols = [
  ...
  'preproc_dispatch_ms',
  'preproc_sync_ms',
  'preproc_plan_yolo_ms',
  'preproc_kernel_yolo_ms',
  'preproc_tile_count_yolo',
  'preproc_plan_crowd_ms',
  'preproc_kernel_crowd_ms',
  'preproc_tile_count_crowd',
  'infer_critical_ms',
  'postdecode_ms',
  'other_ms',
  'other_collect_ms',
  'other_publish_ms',
  'other_encode_ms',
  'video_encode_hotspot_render_ms',
  'video_encode_kernel_ms',
  'video_encode_gpu_draw_event_ms',
  'video_encode_gpu_jpeg_event_ms',
  'video_encode_gpu_input_to_draw_start_ms',
  'video_encode_host_wait_input_event_ms',
  'video_encode_host_wait_nvjpeg_sync_ms',
  'video_encode_host_wait_cpu_copy_sync_ms',
  'other_encode_wait_ms',
  ...
  'server_sse_publish_ms',
  'server_compact_payload_ms',
  'server_meta_ws_push_ms',
  'server_telemetry_update_ms',
  'server_lock_hold_ms',
  'src_copy_sync_ms',
  'trt_prepare_ms',
  'trt_sync_ms',
...
function benchmarkCaptureStopAndDownload() {
  ...
  const columns = [
    ...
    'video_encode_hotspot_render_ms', 'video_encode_kernel_ms',
    'video_encode_gpu_draw_event_ms', 'video_encode_gpu_jpeg_event_ms', 'video_encode_gpu_input_to_draw_start_ms',
    'video_encode_host_wait_input_event_ms', 'video_encode_host_wait_nvjpeg_sync_ms', 'video_encode_host_wait_cpu_copy_sync_ms',
